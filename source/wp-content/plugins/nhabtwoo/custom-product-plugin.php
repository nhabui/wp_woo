...
function custom_products_menu() {
    ...
    add_submenu_page(
        ...
        'Custom Products Settings 01', // Page title for submenu
        'Submenu 01',                  // Menu title for submenu
        'manage_options',              // Capability required to access the submenu
        'custom-products-settings-01', // Menu slug for submenu (unique identifier)
        'custom_submenu_01_page'       // Callback function to display the submenu content
    );
}
add_action('admin_menu', 'custom_products_menu');

// Callback function for submenu page 01
function custom_submenu_01_page() {
    // Display content for submenu 01
    echo '<h1>Custom Submenu Page 01</h1>';
}
